<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MantenedorMarcasUpdate.aspx.cs" Inherits="mantenedorMarcasUpdate" %>
    ...
    <div class="center"><br/>
        ...
        <asp:Table ID="Table1" runat="server" ClientIDMode="Static">
            ...
            <asp:TableRow ID="TableRow1" runat="server" ClientIDMode="Static">
                <asp:TableCell ID="TableCell1" runat="server" ClientIDMode="Static"><asp:Label ID="lblMarca" runat="server" ClientIDMode="Static">Marca</asp:Label></asp:TableCell>
                <asp:TableCell ID="TableCell2" runat="server" ClientIDMode="Static"><asp:TextBox ID="txtMarca" runat="server" ClientIDMode="Static"></asp:TextBox></asp:TableCell>
...
<div class="center">
    <asp:GridView ID="gridMarcas" runat="server" ClientIDMode="Static" AllowPaging="True" AllowSorting="True"
                ...
                ForeColor="#333333" GridLines="None" >
                 ...
                 <Columns >
                   <asp:HyperLinkField DataTextField="marca" HeaderText="marca"  DataNavigateUrlFields="marca" DataNavigateUrlFormatString="mantenedorMarcasUpdate.aspx?marca={0}" />
                   <asp:BoundField DataField="abreviado" HeaderText="abreviado"/>
                   <asp:BoundField DataField="descripcion" HeaderText="descripcion"/>
                   <asp:BoundField DataField="orgVentas" HeaderText="orgVentas"/>
                   
                     <asp:TemplateField FooterText="Eliminar" HeaderText="Eliminar">
                     <ItemTemplate>
                     <a onclick="javascript:confirmar('<%# Eval("marca") %>');" href="#" >Eliminar</a>
                     </ItemTemplate>
                     </asp:TemplateField>
