<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Devolucion_Concesionario.aspx.cs" Inherits="Vistas_Devolucion_Concesionario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:GridView ID="grSolicitudes" runat="server" AutoGenerateColumns="false" EmptyDataText="No se encontraron registros"  OnRowCommand="grSolicitudes_RowCommand" AllowPaging="True" PageSize="20" OnPageIndexChanging="grSolicitudes_PageIndexChanging">
                ...
                <asp:GridView ID="grSolicitudesDetalle" runat="server" AutoGenerateColumns="false">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="fecha_solicitud" HeaderText="Fecha Solicitud" InsertVisible="False"
                            ReadOnly="True" />
                        <asp:BoundField DataField="marca" HeaderText="Marca" InsertVisible="False"
                            ReadOnly="True" />
                        ...
                        <asp:TemplateField Visible="true" HeaderText="Visado Comercial">
                            <ItemTemplate>
                                <asp:CheckBox ID="chAproComercial" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField Visible="true" HeaderText="N° Pedido Devolución">
                            <ItemTemplate>
                                <asp:TextBox ID="txrNumeroNC" runat="server" Enabled="false"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="reqName" ControlToValidate="txrNumeroNC"
                                    ErrorMessage="(*)" ForeColor="Red" Enabled="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField Visible="true" HeaderText="Factura">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hypDocND" runat="server" Target="_blank" NavigateUrl='<%# Eval("url_factura") %>'>Ver</asp:HyperLink>
                                    </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField Visible="true" HeaderText="Observaciones">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtObservacionComercial" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
