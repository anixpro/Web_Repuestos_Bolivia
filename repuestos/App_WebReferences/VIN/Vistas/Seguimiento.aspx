	...
	<table id="Table1">
        ...
        <div id="tabs">
	        <ul>
		        ...
		        <li><a href="#tabs-2" onclick="showfilter('reserva');">Reservas</a></li>
		        <li><a href="#tabs-3" onclick="showfilter('vfc');">VFCs</a></li>
                <li><a href="#tabs-4" onclick="showfilter('descartado');">Descartados</a></li>
	            ...
	            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                            ...
                            DataKeyNames="num_backOrder" DataSourceID="SqlDataSourceReservas" 
                            ForeColor="#333333" GridLines="None" PageSize="13">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="num_backOrder" HeaderText="Ident." 
                                    ReadOnly="True" SortExpression="num_backOrder" />
                                <asp:BoundField DataField="id_pedido" HeaderText="Pedido" 
                                    SortExpression="id_pedido" />
                                <asp:BoundField DataField="rut_user" HeaderText="RUT" 
                                    SortExpression="rut_user" />
                                <asp:BoundField DataField="fecha_creacion" HeaderText="Fecha" 
                                    SortExpression="fecha_creacion" />
                                <asp:BoundField DataField="codigo_rep" HeaderText="Código" 
                                    SortExpression="codigo_rep" />
                                <asp:BoundField DataField="marca" HeaderText="Marca" SortExpression="marca" />
                                <asp:BoundField DataField="cantidad" HeaderText="cantidad" 
                                    SortExpression="cantidad" />
                                <asp:BoundField DataField="detalle_rep" HeaderText="Detalle" 
                                    SortExpression="detalle_rep" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceReservas" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:skbergeConnectionString %>" 
                            ></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
	            ...
	            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView3" runat="server" AllowPaging="True" 
                            AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                            DataKeyNames="num_VFC" DataSourceID="SqlDataSourceVFC" ForeColor="#333333" 
                            GridLines="None" PageSize="13">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="num_VFC" HeaderText="Ident." ReadOnly="True" 
                                    SortExpression="num_VFC" />
                                <asp:BoundField DataField="id_pedido" HeaderText="Pedido" 
                                    SortExpression="id_pedido" />
                                <asp:BoundField DataField="rut_user" HeaderText="RUT" 
                                    SortExpression="rut_user" />
                                ...
                                <asp:BoundField DataField="detalle_rep" HeaderText="Detalle" 
                                    SortExpression="detalle_rep" />
                                <asp:BoundField DataField="cod_vin" HeaderText="VIN" 
                                    SortExpression="cod_vin" />
                                <asp:BoundField DataField="destino" HeaderText="Destino" 
                                    SortExpression="destino" />
                            </Columns>
                            <EditRowStyle BackColor="#999999" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceVFC" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:skbergeConnectionString %>" 
                            ></asp:SqlDataSource>
                    </ContentTemplate>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridView4" runat="server" AllowPaging="True" 
                            AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                            DataKeyNames="idDescartado" DataSourceID="SqlDataSourceDescartados" 
                            ForeColor="#333333" GridLines="None" PageSize="13">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="id_pedido" HeaderText="Pedido" 
                                    SortExpression="id_pedido" />
                                <asp:BoundField DataField="rut_user" HeaderText="Usuario" 
                                    SortExpression="rut_user" />
                                <asp:BoundField DataField="fechaDescarte" HeaderText="Fecha" 
                                    SortExpression="fechaDescarte" />
                                <asp:BoundField DataField="codigo_rep" HeaderText="Codigo" 
                                    SortExpression="codigo_rep" />
                                <asp:BoundField DataField="marca" HeaderText="Marca" SortExpression="marca" />
                                <asp:BoundField DataField="cantidad" HeaderText="Cantidad" 
                                    SortExpression="cantidad" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDescartados" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:skbergeConnectionString %>" 
                            ></asp:SqlDataSource>
                    </ContentTemplate>
                </asp:UpdatePanel>
