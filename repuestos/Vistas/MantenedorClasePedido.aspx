...
<asp:Panel ID="PanelDesactivarClase" runat="server">
 <div class="mantenedorClasePedidoDerecha" style="height:100%">
        ...
        <asp:Table ID="Table2" runat="server" ClientIDMode="Static" CssClass="tablaCrearClasePedido">
            <asp:TableRow ID="TableRow5" runat="server" ClientIDMode="Static">
                <asp:TableCell ID="TableCell10" runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label4" runat="server" ClientIDMode="Static" Text="Nombre Clase:" CssClass="lblNombre"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell12" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="50" ID="TextBox3" runat="server" ClientIDMode="Static" CssClass="txtNombre"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow6" runat="server" ClientIDMode="Static">
                <asp:TableCell ID="TableCell13" runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label5" runat="server" ClientIDMode="Static" Text="Código Clase:" CssClass="lblNombre"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell14" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="30" ID="TextBox4" runat="server" ClientIDMode="Static" CssClass="txtNombre"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow  runat="server" ClientIDMode="Static">
      ...
      <asp:Button ID="Button2" runat="server" ClientIDMode="Static" Text="Guardar Nueva Clase" CssClass="button" OnClick="btnAgregarClase_Click"/>
    </div>
</asp:Panel>
<asp:Panel ID="PanelAsignarClasePedido" runat="server">
 <div class="mantenedorClasePedidoDerecha" style="height:100%">
        ...
        <asp:Table ID="Table3" runat="server" ClientIDMode="Static" CssClass="tablaCrearClasePedido">
            <asp:TableRow ID="TableRow7" runat="server" ClientIDMode="Static">
                <asp:TableCell ID="TableCell16" runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label6" runat="server" ClientIDMode="Static" Text="Nombre Clase:" CssClass="lblNombre"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell17" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="50" ID="TextBox5" runat="server" ClientIDMode="Static" CssClass="txtNombre"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow8" runat="server" ClientIDMode="Static">
                ...
                <asp:TableCell ID="TableCell19" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="30" ID="TextBox6" runat="server" ClientIDMode="Static" CssClass="txtNombre"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow  runat="server" ClientIDMode="Static">
      ...
      <asp:Button ID="Button3" runat="server" ClientIDMode="Static" Text="Guardar Nueva Clase" CssClass="button" OnClick="btnAgregarClase_Click"/>
    </div>
</asp:Panel>
</asp:Content>