<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MantenedorUsuarioUpdate.aspx.cs" Inherits="Vistas_mantenedorUsuarioUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="center">
        <asp:Table ID="Table1" runat="server" ClientIDMode="Static">
            <asp:TableRow ID="trRut" runat="server" ClientIDMode="Static" HorizontalAlign="Center">
                <asp:TableCell ID="tcRut" runat="server" ClientIDMode="Static">
                    <asp:Label ID="lblRut" runat="server" ClientIDMode="Static">Rut</asp:Label></asp:TableCell>
                <asp:TableCell ID="tc2Rut" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="12" ID="txtRut" runat="server" ClientIDMode="Static"></asp:TextBox></asp:TableCell>
                <asp:TableCell>
                    <asp:Button ID="btnBuscar" runat="server" ClientIDMode="Static" Text="Buscar" OnClick="btnBuscar_Click" /></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </div>
    <center>
    ...
    <asp:SqlDataSource ID="sqldPersona" runat="server" ConnectionString="<%$ ConnectionStrings:skbergeConnectionString %>">
    </asp:SqlDataSource>
    <div class="usuarioUpdate">
        <asp:HiddenField ID="hddIdHumano2" runat="server" />
        <asp:Table ID="tblDatos" runat="server" ClientIDMode="Static" Height="202px" Width="283px">
            <asp:TableRow ID="rowConcesionario" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowConcesionario">
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    <asp:Label ID="lblConcesionario" runat="server" ClientIDMode="Static" Text="Concesionario"
                        CssClass="lblConcesionario">
                    </asp:Label>
                </asp:TableCell>
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    <asp:DropDownList ID="ddlConcesionario" runat="server" OnSelectedIndexChanged="ddlConcesionario_SelectedIndexChanged"
                        ClientIDMode="Static" AutoPostBack="True">
                    </asp:DropDownList>
                    <img alt="Ejemplo: 'PALD'" title="Debe ingresar nombre de concesionario. Ej: 'PALD'"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowSucursal" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowSucursal">
                <asp:TableCell ID="tcSucursal" runat="server" ClientIDMode="Static">
                    <asp:Label ID="lblSucursal" runat="server" ClientIDMode="Static" Text="Sucursal"
                        CssClass="lblSucursal"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="rcsucursal2" runat="server" ClientIDMode="Static">
                    <asp:DropDownList ID="ddlSucursal" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ddlConcesionario_SelectedIndexChanged"
                        AutoPostBack="false">
                    </asp:DropDownList>
                    <img alt="Ejemplo: 'Oriente'" title="Debe ingresar nombre de sucursal. Ej: 'Sur'"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowMultiple" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowMultiple">
                <asp:TableCell runat="server" ClientIDMode="Static">
                    <asp:Label ID="lblMultiple" runat="server" ClientIDMode="Static" Text="multiSucursal"
                        CssClass="lblMultiple"></asp:Label>
                </asp:TableCell>
                <asp:TableCell runat="server" ClientIDMode="Static">
                    <asp:CheckBox ID="cbxMultipleSucursal" runat="server" ClientIDMode="Static" CssClass="cbxMultipleSucursal" />
                    <img alt="Multiple sucursal" title="Marque esta opcion si deseea que la persona tenga la capacidad de generar cotizacion a diferentes sucursales"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowReemplazo" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowMultiple">
                ...
                <asp:TableCell ID="TableCell14" runat="server" ClientIDMode="Static">
                    ...
                    <img alt="Reemplazo Supervisor" title="Marque esta opcion si desa que el supervisor vea todos los concesionarios"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowAprobVFC" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowMultiple">
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label1" runat="server" ClientIDMode="Static" Text="Aprobar VFC" CssClass="lblMultiple"></asp:Label>
                </asp:TableCell>
                <asp:TableCell runat="server" ClientIDMode="Static">
                    <asp:CheckBox ID="chkAprobVFC" runat="server" ClientIDMode="Static" CssClass="cbxMultipleSucursal" />
                    <img alt="Aprobar VFC" title="Marque esta opción si desea que el operador visualice todas las cotizaciones de su concesionario."
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowCriticidadVfc" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowMultiple">
                <asp:TableCell ID="TableCell12" runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label3" runat="server" ClientIDMode="Static" Text="Indica Criticidad VFC"
                        CssClass="lblMultiple"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell15" runat="server" ClientIDMode="Static">
                    ...
                    <img alt="Indica Criticidad" title="Marque esta opción si desea que el operador pueda indicar criticidad a un VFC"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="rowDevRec" runat="server" ClientIDMode="Static" Style="display: none"
                CssClass="rowMultiple">
                <asp:TableCell ID="TableCell19" runat="server" ClientIDMode="Static">
                    <asp:Label ID="Label5" runat="server" ClientIDMode="Static" Text="Solicitudes Devoluciones Reclamos"
                        CssClass="lblMultiple"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell20" runat="server" ClientIDMode="Static">
                    ...
                    <img alt="Devoluciones/Reclamos" title="Marque esta opcion si desea habilitar solicitudes de devoluciones y reclamos"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow  runat="server" ClientIDMode="Static">
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    <asp:Label ID="lblTipo" runat="server" ClientIDMode="Static" Text="Tipo Usuario"
                        CssClass="lblTipo"></asp:Label>
                </asp:TableCell>
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    ...
                    <img alt="Ejemplo: 'Cotizador'" title="Escoja tipo de usuario. Estos pueden ser Cotizador, Genrente, "
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow ID="TableRow3" runat="server" ClientIDMode="Static">
                ...
                <asp:TableCell  runat="server" ClientIDMode="Static">
                    ...
                    <img alt="Ejemplo: 'yo@concesionario.cl'" title="Concesionario. Ejemplo:'yo@concesionario.cl'"
                        src="../img/help.png" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow4" runat="server" ClientIDMode="Static">
                ...
                <asp:TableCell ID="TableCell8" runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="5" ID="txtCodigoArea" runat="server" ClientIDMode="Static"
                        Width="23" CssClass="txtTelefono"></asp:TextBox><asp:Label ID="lblGuionFono" runat="server"
                            ClientIDMode="Static" Text="-"></asp:Label>
                    <asp:TextBox MaxLength="10" ID="txtTelefono" runat="server" ClientIDMode="Static"
                        Width="110" CssClass="txtTelefono">
                    </asp:TextBox>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell runat="server" ClientIDMode="Static">
                    <asp:TextBox MaxLength="50" ID="txtIdllave" runat="server" ClientIDMode="Static"
                        CssClass="txtidllave"></asp:TextBox>
            ...
            <asp:TableRow ID="TableRow5" runat="server" ClientIDMode="Static">
                <asp:TableCell ID="TableCell11" runat="server" ClientIDMode="Static" ColumnSpan="2"
                    HorizontalAlign="Center">
                    <asp:Button ID="btnAgregar" runat="server" ClientIDMode="Static" Text="Aceptar" CssClass="button"
                        OnClick="btnAgregar_Click" />
                    &nbsp;
                    <asp:Button ID="btnVolver" runat="server" ClientIDMode="Static" Text="Volver" CssClass="button"
