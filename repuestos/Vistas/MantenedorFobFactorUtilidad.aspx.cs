...
public partial class Vistas_MantenedorFobFactorUtilidad : System.Web.UI.Page
{
    ...
    protected void dgvTramos_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            _sql = "SELECT * FROM fob_factores_utilidad WHERE id = '" + id + "' ";
            ...
            StreamWriter arch = new StreamWriter(path + "/log_factor_utilidad.txt", true);
            ...
            cmd.CommandText = "webr_fob_actualiza_factor_utilidad";
            ...
            StreamWriter arch2 = new StreamWriter(path + "/log_factor_utilidad.txt", true);
        ...
        if (e.CommandName == "elimina")
        {
            try
            {
                ...
                if (lblId != null)
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.CommandText = "webr_fob_factor_utilidad";
                    cmd.CommandTimeout = 10;
    ...
    protected void btnAgregar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.CommandText = "webr_fob_agrega_factor_utilidad";
            cmd.CommandTimeout = 10;
    ...
    private void cargarGrilla()
    {
        ...
        dgvTramos.DataSource = _SQL.obtieneFactorUtilidad(ddlMarca.SelectedValue, ddlGrupoTecnico.SelectedValue, out coderror, out msgerror);
        dgvTramos.DataBind();
    }
}