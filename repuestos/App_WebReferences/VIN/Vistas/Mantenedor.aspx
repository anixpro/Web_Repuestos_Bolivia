...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="mantenedorUsuariosDerecha">
        ...
        <asp:Table ID="tblDatos" runat="server" ClientIDMode="Static" CssClass="tablaCrearUsuario">
            ...
            <asp:TableRow runat="server" ClientIDMode="Static">
                <asp:TableCell runat="server" ClientIDMode="Static"><asp:Label ID="lblTelefono" runat="server" ClientIDMode="Static" Text="Telefono" CssClass="lblTelefono"></asp:Label>
                </asp:TableCell>
                <asp:TableCell runat="server" ClientIDMode="Static">
