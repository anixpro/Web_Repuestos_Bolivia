<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MantenedorConcesionarioEliminaMarca.aspx.cs" Inherits="MantenedorConcesionarioEliminaMarca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="titulo">
        Mantenedor de concesionarios: Desasociar marcas de un conecesionario
    </div>
    ...
    <div class="mantenedorConcesionariosIzquierda">
        ...
        <ul>
            <li>
                <asp:HyperLink ID="HyperLink1" runat="server" ClientIDMode="Static" NavigateUrl="~/Vistas/MantenedorConcesionarioInsert.aspx">Insertar nuevo</asp:HyperLink>
            </li>
            <li>
            ...
            <li>
                <asp:HyperLink ID="HyperLink2" runat="server" ClientIDMode="Static" NavigateUrl="~/Vistas/SucursalesLista.aspx">Ver Sucursales</asp:HyperLink>
            </li>
        </ul>
    </div>
    <div class="mantenedorConcesionariosDerecha">
        <b><u>Marcas a desasociar:</u></b>
        <asp:CheckBoxList ID="cbxlMarcas" runat="server" ClientIDMode="Static" RepeatDirection="Horizontal" RepeatColumns="4"></asp:CheckBoxList><br />
        ...
        <asp:Table ID="tblDatos" runat="server" ClientIDMode="Static">
            <asp:TableRow ID="TableRow1" runat="server" ClientIDMode="Static">
                ...
                <asp:TableCell ID="TableCell2" runat="server" ClientIDMode="Static">
                    <asp:DropDownList ID="ddlConcesionario" runat="server" ClientIDMode="Static" AutoPostBack="true"></asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow3" runat="server" ClientIDMode="Static" HorizontalAlign="Center">
                <asp:TableCell ID="TableCell6" runat="server" ClientIDMode="Static" ColumnSpan="2"><asp:Button ID="btnAgregar" runat="server" ClientIDMode="Static" Text="Desasociar" onclick="btnAgregar_Click" CssClass="button"/>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </div>
