    ...
    protected void btnAceptar_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           //txtVin
            ...
            string tipoPed = RadioButtonList1.SelectedValue;
            ...
            if (RadioButtonList1.SelectedValue == "NORMAL")
            {
                try
                {
                    ...
                    consulta.Credentials = new System.Net.NetworkCredential("INTSOPI_SKBP", "InSoa2015_P");
        ...
        try
        {
            ...
            textoCorreo = "Usted ha realizado solicitud (reservas y/o VFCs) de repuestos a SKBergé. Le recordamos que las reservas se despacharán y facturarán una vez arribados los repuestos a nuestra bodega";
            ...
            _mail.EnviarCorreo(para + "," + ConfigurationManager.AppSettings["correo_error"].ToString(), asunto, textoCorreo, cc);
