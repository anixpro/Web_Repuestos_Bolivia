<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ListarSolicitudes.aspx.cs" Inherits="Vistas_ListarSolicitudes" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:skbergeConnectionString %>" SelectCommand="select persona.rut,persona.nombre from persona
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="2">
                        <asp:Button runat="server" ID="btnBuscarExacto" Text="Buscar" 
                            onclick="btnBuscarExacto_Click"/>
                    </td>
                </tr>
            </tbody>
            <tfoot></tfoot>
        </table>
        <asp:GridView ID="gvBusquedaExacta" runat="server" AutoGenerateColumns="False" 
    ...
    <div id="divBusquedaFiltros">
        ...
        <table>
            ...
            <tr id="trRutColegas" runat="server">
                ...
                <td>
                    <asp:DropDownList ID="ddlOperarios" runat="server" 
                        DataSourceID="SqlDataSource1" DataTextField="nombre" DataValueField="rut">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFechaBusquedaInicio" runat="server" 
                        ClientIDMode="Static"></asp:TextBox>
                    <asp:CalendarExtender ID="BuscarBoleCal" runat="server"
                    TargetControlID="txtFechaBusquedaInicio" PopupButtonID="ImageButton1" 
                        Format="yyyy-MM-dd"/>
                    <asp:ImageButton runat="Server" ID="ImageButton1" ImageUrl="~/img/calendarIcon.png" AlternateText="Haga clic aqui para desplegar el calendario" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtFechaBusquedaFin" runat="server" 
                        ClientIDMode="Static"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender1" runat="server"
                    TargetControlID="txtFechaBusquedaFin" PopupButtonID="ImageButton2" 
                        Format="yyyy-MM-dd"/>
                    <asp:ImageButton runat="Server" ID="ImageButton2" ImageUrl="~/img/calendarIcon.png" AlternateText="Haga clic aqui para desplegar el calendario" />
                </td>
            </tr>
            <tr>
                <td>
        ...
        <asp:GridView ID="gvSolicitudes" runat="server" Caption="Lista de solicitudes" 
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Id_solicitud" HeaderText="Solicitud" ItemStyle-HorizontalAlign="Center" NavigateUrl="ListarSolicitudes.aspx" ControlStyle-CssClass="lnkIdSolicitud" />
                <asp:BoundField HeaderText="Producto"
                    ItemStyle-HorizontalAlign="Center" DataField="producto">
                </asp:BoundField>
                <asp:BoundField HeaderText="VIN" ItemStyle-CssClass="gridViewRowSmall"
                    ItemStyle-HorizontalAlign="Center" DataField="vin">
                </asp:BoundField>
                <asp:BoundField HeaderText="Marca"
                    ItemStyle-HorizontalAlign="Center" DataField="marca">
                </asp:BoundField>
                <asp:BoundField HeaderText="Fec.Est."
                    ItemStyle-HorizontalAlign="Center" DataField="fecha_eta">
                </asp:BoundField>
                <asp:BoundField HeaderText="Creado"
                    ItemStyle-HorizontalAlign="Center" DataField="fecha_creacion">
                </asp:BoundField>
                <asp:BoundField HeaderText="Venta"
                    ItemStyle-HorizontalAlign="Center" DataField="tipovfc">
                </asp:BoundField>
                <asp:BoundField HeaderText="Dirección"
                    ItemStyle-HorizontalAlign="Center" DataField="direccion">
                </asp:BoundField>
                <asp:BoundField HeaderText="Tipo"
                    ItemStyle-HorizontalAlign="Center" DataField="tipopedido">
                </asp:BoundField>
                <asp:BoundField HeaderText="Estado"
                    ItemStyle-HorizontalAlign="Center" DataField="estado">
                </asp:BoundField>
            </Columns>
