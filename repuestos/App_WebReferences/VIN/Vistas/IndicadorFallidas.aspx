<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IndicadorFallidas.aspx.cs" Inherits="Vistas_indicadorFallidas" %>
 ...
 <!--Load the AJAX API-->
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            data.addColumn('number', 'fallida');
            data.addRows(1); //este el largo de la cantidad columnas una fila columna contiene varias barras
            data.setValue(0, 0, 'Cantidad');
            data.setValue(0, 1, <%=_fallidas %>);



            var chart = new google.visualization.ColumnChart(document.getElementById('chart_div'));
            chart.draw(data, { width: 700, height: 240, title: 'Ventas fallidas $',
                hAxis: { title: 'Ventas fallidas', titleTextStyle: { color: 'red'} }, vAxis: { title: 'Pesos', titleTextStyle: { color: 'red'} },
...
<asp:TableRow ID="rowRut" runat="server" ClientIDMode="Static" Style="display:none;">
            ...
            <asp:TableCell ID="TableCell6" runat="server" ClientIDMode="Static"><asp:TextBox ID="txtRut" Width="113" runat="server" ClientIDMode="Static"></asp:TextBox><asp:Label ID="lblGuion" runat="server" ClientIDMode="Static" Text="-"></asp:Label><asp:TextBox ID="txtDvr" runat="server" Width="20" MaxLength="1" ClientIDMode="Static"></asp:TextBox>
</asp:TableCell>
        </asp:TableRow>
