...
/// <summary>
/// Descripción breve de AmbienteERP
/// </summary>
public class AmbienteERP
{
    //CHILE 
    //Variables para la consulta de repuestos
    //ERQ.DT_Web_Repuestos _localDtWebRepuestos = new ERQ.DT_Web_Repuestos();

    ERP.ZEWS004 _localDtWebRepuestos = new ERP.ZEWS004();
    public ERP.ZEWS004 LocalDtWebRepuestos
    {
    ...
    ERP.ZEWS026 _localDtWebRepuestosItem = new ERP.ZEWS026();
    public ERP.ZEWS026 LocalDtWebRepuestosItem
    {
    ...
    ERP.SI_ConsultaRepuesto_oaService _WsConsultaRepuesto = new ERP.SI_ConsultaRepuesto_oaService();
    public ERP.SI_ConsultaRepuesto_oaService WsConsultaRepuesto
    {
    ...
    ERP.ZEWS027 _WsResponseConsultaRepuesto = new ERP.ZEWS027();
    public ERP.ZEWS027 WsResponseConsultaRepuesto
    {
    ...
    ERP.DT_Generacion_Pedido_Venta_RequestORDER_HEADER_IN _WsCreaPedido = new ERP.DT_Generacion_Pedido_Venta_RequestORDER_HEADER_IN();
    public ERP.DT_Generacion_Pedido_Venta_RequestORDER_HEADER_IN WsCreaPedido
    {
        get { return _WsCreaPedido; }
        set { _WsCreaPedido = value; }
    }

    ERP.DT_Generacion_Pedido_Venta_RequestORDER_ITEMS_IN _WsCreaPedido_1 = new ERP.DT_Generacion_Pedido_Venta_RequestORDER_ITEMS_IN();
    public ERP.DT_Generacion_Pedido_Venta_RequestORDER_ITEMS_IN WsCreaPedido_1
    {
        get { return _WsCreaPedido_1; }
        set { _WsCreaPedido_1 = value; }
    }

    ERP.DT_Generacion_Pedido_Venta_Request _WsCreaPedidoItem = new ERP.DT_Generacion_Pedido_Venta_Request();
    public ERP.DT_Generacion_Pedido_Venta_Request WsCreaPedidoItem
    {
        get { return _WsCreaPedidoItem; }
        set { _WsCreaPedidoItem = value; }
    }

    ERP.SI_Generacion_Pedido_Venta_OutService _WsCreaPedidoVenta = new ERP.SI_Generacion_Pedido_Venta_OutService();
    public ERP.SI_Generacion_Pedido_Venta_OutService WsCreaPedidoVenta
    {
        get { return _WsCreaPedidoVenta; }
        set { _WsCreaPedidoVenta = value; }
    }

    ERP.DT_Generacion_Pedido_Venta_Response _WsCreaPedidoResponse = new ERP.DT_Generacion_Pedido_Venta_Response();
    public ERP.DT_Generacion_Pedido_Venta_Response WsCreaPedidoResponse
    {
    ...
    ERP.DT_Generacion_Pedido_Venta_Response _dtWebPdoVtas = new ERP.DT_Generacion_Pedido_Venta_Response();
    public ERP.DT_Generacion_Pedido_Venta_Response DtWebPdoVtas
    {
    ...
    ERP.DT_Generacion_Pedido_Venta_Request _dtWebPdoVtasPedido = new ERP.DT_Generacion_Pedido_Venta_Request();
    public ERP.DT_Generacion_Pedido_Venta_Request DtWebPdoVtasPedido
    {
    ...
    ERP.DT_Generacion_Pedido_Venta_Response _wsResponse = new ERP.DT_Generacion_Pedido_Venta_Response();
    public ERP.DT_Generacion_Pedido_Venta_Response WsResponse1
    {
        get { return _wsResponse; }
        set { _wsResponse = value; }
    }
    ...
    // consultar estado
    ERP.SI_Consulta_Estado_Pedido_Venta_OutService _wsConsultaPedido = new ERP.SI_Consulta_Estado_Pedido_Venta_OutService();
    public ERP.SI_Consulta_Estado_Pedido_Venta_OutService WsConsultaPedido
    {
